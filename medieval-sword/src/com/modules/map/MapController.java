...
public class MapController {
  ...
  public MapController( MyGdxGame game, List<Player> players, Terrain terrain,
      MapUserInterface ui, LevelObjectives objectives, List<CreaturesGroup> creatures ) {
    this.game = game;
  ...
  public void checkEvents() {
    switch(typeEvent) {
      ...
      case MapConstants.EXIT_GAME:
        ...
        break;
      case MapConstants.SAVE_GAME:
        Assets.saveLevel(terrain, players, creatures, objectives);
        break;
      case MapConstants.WIN_BATTLE:
        if( selected_group != null ) {
          creatures.remove( selected_group );
          selected_group = null;
        }
        break;
    }
  ...
  private TweenCallback getResourcePileCallback() {
    return new TweenCallback() {
      public void onEvent(int type, BaseTween<?> source) {
        ...
        terrain.removePile( selected_pile );
        ui.updateHudResources( getTurnPlayer() );
      }
    };
  }
