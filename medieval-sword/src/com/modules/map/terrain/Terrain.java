...
public class Terrain {
  ...
  public int isExplored( int x, int y ) {
    return explored[y][x];
  }
  ...
  public void removePile( ResourcePile pile) {
    getSquareTerrain( pile.square_position_number ).setFree();
    stage.removeActor( pile.getActor() );
    resource_piles.remove(pile);
  }
}
